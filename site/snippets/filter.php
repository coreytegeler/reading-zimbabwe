<?php
echo '<div id="filter">';
	echo '<div id="filterTabs" class="tabs real">';
		echo '<div class="inner">';
			echo '<div class="vert">';
				echo '<div class="tab filter" data-slug="decade"><span>Decade</span></div>';
				echo '<div class="tab filter" data-slug="location"><span>Location</span></div>';
				echo '<div class="tab filter" data-slug="publisher"><span>Publisher</span></div>';
		...
		echo '<div id="filterLists" class="pages">';
			echo '<div class="inner">';
				...
				echo '<div class="page filterList publisher" data-type="publisher">';
					echo '<div class="filters">';
